...
(function() {
  ...
  Vp.Models.FlickrImage = (function(_super) {
    __extends(FlickrImage, _super);

    function FlickrImage() {
      _ref = FlickrImage.__super__.constructor.apply(this, arguments);
      return _ref;
    }
...
(function() {
  ...
  Vp.Models.GoogleEvent = (function(_super) {
    ...
    GoogleEvent.prototype.startDate = function() {
      ...
      if (d = this.get('start')) {
        if (dd = d.date) {
          console.log(dd);
          return moment(dd).format('dddd, MMMM Do');
        }
      }
    };
    ...
    GoogleEvent.prototype.dateOrDateTime = function() {
      return this.startDate() || this.timeString();
    };
...
(function() {
  ...
  Vp.Models.PhotoSet = (function(_super) {
    __extends(PhotoSet, _super);

    function PhotoSet() {
      _ref = PhotoSet.__super__.constructor.apply(this, arguments);
      return _ref;
    }

    PhotoSet.prototype.url = function() {
      return 'http://api.flickr.com/services/rest/?method=flickr.photosets.getPhotos&api_key=' + Vp.flickrApiKey + '&photoset_id=' + this.id + '&format=json&nojsoncallback=1';
    };
    ...
    PhotoSet.prototype.photos = function() {
      return new Vp.Collections.Photos({
        collection: this.get("photo")
      });
    };
...
(function() {
  ...
  Vp.Collections.FlickrImages = (function(_super) {
    __extends(FlickrImages, _super);

    function FlickrImages() {
      _ref = FlickrImages.__super__.constructor.apply(this, arguments);
      return _ref;
    }
    ...
    FlickrImages.prototype.url = function() {
      return 'http://api.flickr.com/services/rest/?method=flickr.photosets.getPhotos&api_key=' + Vp.flickrApiKey + '&photoset_id=' + this.photosetId + '&format=json&nojsoncallback=1&extras=title%2Cdescription';
    };
...
(function() {
  ...
  Vp.Collections.GoogleEvents = (function(_super) {
    ...
    GoogleEvents.prototype.model = Vp.Models.GoogleEvent;
...
(function() {
  ...
  Vp.Views.Gallery = (function(_super) {
    ...
    Gallery.prototype.tagName = 'ul';

    Gallery.prototype.className = 'images';
...
(function() {
  ...
  Vp.Views.GalleryThumbnail = (function(_super) {
    __extends(GalleryThumbnail, _super);

    function GalleryThumbnail() {
      _ref = GalleryThumbnail.__super__.constructor.apply(this, arguments);
      return _ref;
    }
...
(function() {
  ...
  Vp.Views.Product = (function(_super) {
...
(function() {
  ...
  Vp.Views.Products = (function(_super) {
...
(function() {
  ...
  Vp.Views.UpcomingEvents = (function(_super) {
